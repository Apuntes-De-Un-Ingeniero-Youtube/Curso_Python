...
print(f'Vector números divisibles entre 2 y 6 en un rango {A}, {B} -> {vector}')

# Solución del ejercicio empleando List Comprehensions
vector = [numero for numero in range(A, B, 1) if numero % 2 == 0 if numero % 6 == 0]
print(f'LVector números divisibles entre 2 y 6 en un rango {A}, {B} -> {vector}')